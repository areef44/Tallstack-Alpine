<div class="flex container justify-between w-full shadow-lg shadow-slate-600/50 p-3">
...
<div>
    <button type="submit" class="p-2 bg-red-500 text-white font-bold rounded-md" wire:click='prevPage()'>Prev</button>
    <button type="submit" class="p-2 bg-red-500 text-white font-bold rounded-md" wire:click='nextPage()'>Next</button>
</div>
